...
async def nulis(client: Client, message: Message):
    ...
    async for kontol in client.search_messages(bot, filter="photo", limit=1):
        await client.send_photo(chat, photo=kontol.photo.file_id, caption=f"📌 **Writing by Dam-Ubot**")
        await Cilik.delete()
        await kontol.delete()
